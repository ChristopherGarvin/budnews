  ...
  render () {
    return (
      <div className="news-faq-wrapper">
        <HeadMetadata
          title="{process.env.PRODUCT_NAME} FAQ"
        />
        <GoogleAnalytics />
        ...
        <div className="news-faq-text-container">
          <h1 className="news-faq-text-title">{process.env.PRODUCT_NAME} FAQ</h1>
          ...
          <p>If you have an email address in your profile, request a password reset <a href="/forgot">here</a>.</p>{/** <p> If you haven’t, email support@codernews.com for help.</p>**/}
